...
procedure TAcessoRetaguarda.SetCategoria(const Value: string);
begin
  FCategoria := Value;
end;

procedure TAcessoRetaguarda.Setcodigo(const Value: string);
var
  codigo : string;
begin
...
procedure TAcessoRetaguarda.SetCodigoFuncao(const Value: string);
begin
  FCodigoFuncao := Value;
end;

procedure TAcessoRetaguarda.SetDescricao(const Value: string);
begin
...
procedure TAcessoRetaguarda.SetFuncaoNivel(const Value: string);
begin
  FFuncaoNivel := Value;
end;

procedure TAcessoRetaguarda.SetfuncaoSolicitaSenha(const Value: string);
var
solic:string;
begin
  solic := value;
