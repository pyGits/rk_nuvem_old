object frmAcessoRetaguarda: TfrmAcessoRetaguarda
  Left = 0
  Top = 0
  Caption = 'Configura'#231#245'es > Acesso Retaguarda'
  ClientHeight = 454
  ClientWidth = 606
  Color = clBtnFace
