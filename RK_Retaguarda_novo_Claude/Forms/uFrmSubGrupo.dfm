object frmSubGrupo: TfrmSubGrupo
  Left = 0
  Top = 0
  Caption = 'Cadastro > Produto > Classifica'#231#227'o > SubGrupo'
  ClientHeight = 597
  ClientWidth = 753
  Color = clBtnFace
  ...
  object pcSubGrupo: TPageControl
    Left = 0
    Top = 113
    Width = 753
    Height = 484
    ActivePage = tsDetalheSub
    Align = alClient
    TabOrder = 1
    OnChange = pcSubGrupoChange
    object tsLista: TTabSheet
      Caption = 'Lista de subgrupos'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object tsDetalheSub: TTabSheet
      ...
      object edtCodigoGrupo: TEdit
        ...
        ParentFont = False
        TabOrder = 2
        OnExit = edtCodigoGrupoExit
        OnKeyPress = edtCodigoGrupoKeyPress
      end
