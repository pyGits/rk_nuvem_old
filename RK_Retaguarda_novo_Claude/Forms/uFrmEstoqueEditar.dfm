object frmEstoqueEditar: TfrmEstoqueEditar
  Left = 0
  Top = 0
  ...
  object Panel6: TPanel
    ...
    object edtAdcEstoque: TJvCalcEdit
      Left = 149
      Top = 178
      Width = 145
      Height = 26
      ...
      OnExit = edtAdcEstoqueExit
      OnKeyPress = edtAdcEstoqueKeyPress
    end
    object edtEstoqueAtual: TJvCalcEdit
      Left = 119
      Top = 119
      Width = 180
      Height = 26
      ...
      OnKeyPress = edtEstoqueAtualKeyPress
    end
    object edtDimEstoque: TJvCalcEdit
      Left = 445
      Top = 178
      Width = 148
      Height = 26
      ...
      TabOrder = 5
      DecimalPlacesAlwaysShown = False
      OnExit = edtDimEstoqueExit
      OnKeyPress = edtDimEstoqueKeyPress
    end
    ...
    object grpValidade: TGroupBox
      ...
      object edtDiasVenc: TEdit
        ...
        ParentFont = False
        TabOrder = 1
        OnKeyPress = edtDiasVencKeyPress
        OnKeyUp = edtDiasVencKeyUp
      end
    end
    object edtEstoqueAnterior: TJvCalcEdit
      Left = 602
      Top = 119
      Width = 180
      Height = 26
    ...
    object chkValidade: TCheckBox
      Left = 9
      Top = 225
      Width = 111
      Height = 17
      Caption = 'Inserir Validade'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
      ...
      ParentFont = False
      TabOrder = 8
      OnClick = chkValidadeClick
    end
    object edtQtdAlterada: TJvCalcEdit
      Left = 416
      Top = 119
      Width = 180
      Height = 26
