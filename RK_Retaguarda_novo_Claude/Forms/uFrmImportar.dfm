object frmImportar: TfrmImportar
  ...
  object Panel1: TPanel
    ...
    object btnImportarCompleto: TAdvGlowButton
      Left = 40
      Top = 382
      Width = 92
      Height = 91
      Caption = 'Importar - Completo'
      ...
      Transparent = True
      TabOrder = 0
      OnClick = btnImportarCompletoClick
    ...
    object cbImportar: TComboBox
      ...
      ItemIndex = 0
      TabOrder = 1
      Text = 'Importar Cadastro - Syspdv'
      OnChange = cbImportarChange
      Items.Strings = (
        'Importar Cadastro - Syspdv'
        'Importar Cadastro - RK Pdv'
        'Importar Cadastro - Syspdv SQL')
    end
    object memLog: TMemo
      Left = 40
      Top = 62
