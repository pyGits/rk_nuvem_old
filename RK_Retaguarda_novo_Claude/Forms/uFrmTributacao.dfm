object frmTributacao: TfrmTributacao
  Left = 0
  Top = 0
  Caption = 'Cadastro > Produto > Tributa'#231#227'o'
  ClientHeight = 590
  ClientWidth = 810
  Color = clBtnFace
  ...
  object pcTributacao: TPageControl
    Left = 0
    Top = 113
    Width = 810
    Height = 477
    ...
    Align = alClient
    TabOrder = 1
    OnChange = pcTributacaoChange
    object tsLista: TTabSheet
      Caption = 'Lista de tributa'#231#245'es'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
      ...
      object grid: TNextGrid
        ...
        object NxTextColumn1: TNxTextColumn
          ...
          Font.Name = 'Courier New'
          Font.Style = []
          Header.Caption = 'Tributa'#231#227'o'
          Header.Alignment = taCenter
          Header.Font.Charset = DEFAULT_CHARSET
          Header.Font.Color = clWindowText
          Header.Font.Height = -11
    ...
    object tsDetalhe: TTabSheet
      ...
      object cbCSOSN: TComboBox
        ...
        TabOrder = 4
        Text = '00'
        OnKeyPress = cbCSOSNKeyPress
      end
      object cbST: TComboBox
        Left = 84
        Top = 169
        Width = 45
        Height = 27
        TabOrder = 5
        Text = '00'
        OnKeyPress = cbSTKeyPress
      end
      object edtICMS: TRzNumericEdit
        Left = 270
        Top = 169
        Width = 65
        Height = 27
