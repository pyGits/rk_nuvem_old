...
begin
  ...
  begin
    ...
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000001'+chr(39)+', NULL, '+chr(39)+'Produto'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');       ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000002'+chr(39)+', NULL, '+chr(39)+'Grupo'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');         ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000003'+chr(39)+', NULL, '+chr(39)+'Subgrupo'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');      ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000004'+chr(39)+', NULL, '+chr(39)+'Funcionário'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');   ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000006'+chr(39)+', NULL, '+chr(39)+'Cliente'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');       ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000007'+chr(39)+', NULL, '+chr(39)+'Fornecedor'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');    ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000008'+chr(39)+', NULL, '+chr(39)+'Tributação'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');    ');
    sNivel.Add('INSERT INTO RETAGUARDA_NIVEL (CODIGO, ACFUNC, FUNCDESC, FUNCCAT, FUNCNIV, FUNCSOLIC) VALUES ('+chr(39)+'000009'+chr(39)+', NULL, '+chr(39)+'Finalizadora'+chr(39)+', '+chr(39)+'CADASTRO'+chr(39)+', '+chr(39)+'0;1;2;'+chr(39)+', '+chr(39)+'0'+chr(39)+');  ');
