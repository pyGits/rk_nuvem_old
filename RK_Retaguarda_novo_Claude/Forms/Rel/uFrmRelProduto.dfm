object frmRelProduto: TfrmRelProduto
  Left = 0
  Top = 0
  Caption = 'Relat'#243'rios > Caixa > Produtos'
  ClientHeight = 537
  ClientWidth = 626
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    object cmbTipo: TComboBox
      ...
      ItemIndex = 0
      TabOrder = 2
      Text = 'Relat'#243'rio Curva ABC'
      Items.Strings = (
        'Relat'#243'rio Curva ABC'
        'Listar Produtos'
        'Produtos Cancelados')
    end
    ...
    object GroupBox1: TGroupBox
      ...
      object edtFormaPagamento: TEdit
        ...
        TabOrder = 11
        Text = '000'
        OnEnter = edtFormaPagamentoEnter
        OnExit = edtFormaPagamentoExit
        OnKeyPress = edtFormaPagamentoKeyPress
      end
      object edtFormaPagamentoDesc: TEdit
        Left = 175
        Top = 157
        Width = 274
        Height = 21
    ...
    object StatusBar1: TStatusBar
      ...
      Panels = <
        item
          Text = 'PRESSIONE F2 PARA PESQUISAR'
          Width = 50
        end>
    end
