object frmExtratoEstoque: TfrmExtratoEstoque
  ...
  Caption = 'Relat'#243'rio > Estoque > Extrato'
  ClientHeight = 336
  ClientWidth = 732
  Color = clBtnFace
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 343
      Height = 23
      Caption = 'Relat'#243'rio Movimenta'#231#227'o de Estoque'
  ...
  object pnl1: TPanel
    ...
    object edtCodFuncionario: TEdit
      ...
      TabOrder = 0
      Text = '000000'
      OnClick = edtCodFuncionarioClick
      OnExit = edtCodFuncionarioExit
      OnKeyPress = edtCodFuncionarioKeyPress
    end
