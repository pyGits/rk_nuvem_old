object frmFinalizadora: TfrmFinalizadora
  Left = 0
  Top = 0
  Caption = 'Cadastro > Caixa > Finalizadora'
  ClientHeight = 590
  ClientWidth = 734
  Color = clBtnFace
  ...
  object pcFinalizadora: TPageControl
    Left = 0
    Top = 113
    Width = 734
    Height = 477
    ...
    Align = alClient
    TabOrder = 1
    OnChange = pcFinalizadoraChange
    object tsLista: TTabSheet
      Caption = 'Lista de finalizadoras'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object tsDetalhe: TTabSheet
      ...
      object rdEspecie: TRadioGroup
        Left = 12
        Top = 117
        Width = 213
        Height = 292
        Caption = 'Esp'#233'cie (SAT) '
        Items.Strings = (
          '01 - Dinheiro'
          '02 - Cheque'
