...
type TContasReceber = class
  private
    ...
    procedure Setvalor_parcela(const Value: real);
  public
  ...
  property valor_parcela:real read Fvalor_parcela write Setvalor_parcela;


  procedure lancarPagamento(vlrPago:real);
end;
...
procedure TContasReceber.lancarPagamento(vlrPago: real);
begin
  Fvalor_pago := vlrPago;
end;

procedure TContasReceber.Setcancelado(const Value: integer);
begin
  Fcancelado := Value;
end;

procedure TContasReceber.Setcodigo(const Value: string);
begin
  Fcodigo := Value;
end;

procedure TContasReceber.Setcod_caixa(const Value: integer);
begin
  Fcod_caixa := Value;
end;

procedure TContasReceber.Setcod_cliente(const Value: string);
begin
  Fcod_cliente := Value;
end;

procedure TContasReceber.Setcod_cupom(const Value: string);
begin
  Fcod_cupom := Value;
end;

procedure TContasReceber.Setcod_vendedor(const Value: integer);
begin
  Fcod_vendedor := Value;
end;

procedure TContasReceber.Setdata_emissao(const Value: TDate);
begin
  Fdata_emissao := Value;
end;

procedure TContasReceber.Setdata_pagamento(const Value: TDate);
begin
  Fdata_pagamento := Value;
end;

procedure TContasReceber.Setdata_vencimento(const Value: TDate);
begin
  Fdata_vencimento := Value;
end;

procedure TContasReceber.Setstatus(const Value: integer);
begin
  Fstatus := Value;
end;

procedure TContasReceber.Setvalor(const Value: real);
begin
  Fvalor := Value;
end;

procedure TContasReceber.Setvalor_acrescimo(const Value: real);
begin
  Fvalor_acrescimo := Value;
end;

procedure TContasReceber.Setvalor_desconto(const Value: real);
begin
  Fvalor_desconto := Value;
end;

procedure TContasReceber.Setvalor_pago(const Value: real);
begin
  Fvalor_pago := Value;
end;

procedure TContasReceber.Setvalor_parcela(const Value: real);
begin
  Fvalor_parcela := Value;
end;

procedure TContasReceber.Setvalor_restante(const Value: real);
begin
