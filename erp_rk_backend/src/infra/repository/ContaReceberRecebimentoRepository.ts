...
import { ReciboIdentidade } from "./ContaReceberReciboRepository";
...
export default interface ContaReceberRecebimentoRepository {
  ...
  insertByTitulo(titulo: ContaReceberTitulo, tenant_id: number, db?: Queryable, recibo?: ReciboIdentidade): Promise<void>;
...
export class ContaReceberRecebimentoRepositoryPG implements ContaReceberRecebimentoRepository {
  ...
  async insertByTitulo(titulo: ContaReceberTitulo, tenant_id: number, db: Queryable = DatabaseConnection, recibo?: ReciboIdentidade): Promise<void> {
