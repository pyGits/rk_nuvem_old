...
interface
  uses INIFiles, Winapi.Windows ,vcl.forms,System.SysUtils,System.classes,System.Character,System.Math,System.DateUtils;
  ...
  function Iso8601ToDateOnly(const AValue: string): TDate;
...
var
  LDateTime: TDateTime;
begin
  // chama a função nativa do Delphi
  LDateTime := System.DateUtils.ISO8601ToDate(AValue, False);
  Result := DateOf(LDateTime); // só a parte da data
end;
