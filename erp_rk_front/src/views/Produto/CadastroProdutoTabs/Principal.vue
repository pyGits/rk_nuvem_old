  ...
  data() {
    return {
      unidades: [
        ...
        { codigo: "FD", descricao: "FD - Fardo" },
        { codigo: "PCT", descricao: "PCT - Pacote" },
        { codigo: "PC", descricao: "PC - Peça" },
        { codigo: "DZ", descricao: "DZ - Dúzia" },
        { codigo: "LT", descricao: "LT - Litro" },
        { codigo: "ML", descricao: "ML - Mililitro" },
        { codigo: "MT", descricao: "MT - Metro" },
        { codigo: "M2", descricao: "M2 - Metro Quadrado" },
        { codigo: "M3", descricao: "M3 - Metro Cúbico" },
        { codigo: "SC", descricao: "SC - Saco" },
        { codigo: "ROL", descricao: "ROL - Rolo" },
        { codigo: "PAR", descricao: "PAR - Par" },
        { codigo: "TON", descricao: "TON - Tonelada" },
      ],
      balancas_list: [
