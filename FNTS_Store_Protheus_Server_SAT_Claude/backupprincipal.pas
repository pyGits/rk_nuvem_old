...
//                        qrcaixa_mov.SQL.Add('UPDATE C000032 SET MOVIMENTO_ESTOQUE = MOVIMENTO_ESTOQUE WHERE CODIGO = (SELECT MAX(CODIGO) FROM C000032)');
              ...
              begin
                Application.ProcessMessages;
//                ShowMessage(qrpdv.fieldbyname('codigo').asstring);
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa            // se for dinheiro
                        qrcaixa_mov.close;
                        qrcaixa_mov.sql.clear;
                        ...
                        qrCaixa_mov.ParamByName('Valor').AsFloat := qrForma.FieldByName('VALOR_TOTAL').AsFloat;
                        ...
                        on E:Exception
                          do begin
                            ...
                            begin
                            atualizaPendenciaCupom(qrForma.FieldByName('NUMERO').AsString);
                            end;
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add(':VALOR_ENTRADA,:VALOR,:VALOR_SAIDA,''100002'',8,''Venda '+qrFinalizadora.FieldByName('FZDES').AsString+' - CUPOM No. ' + qrpdv.fieldbyname('numero').asstring + ''',:cancelado,:numero,0, :HORA,:forma,:PRESTACAO)');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                        qrCaixa_mov.ParamByName('VALOR_ENTRADA').AsFloat := qrForma.FieldByName('VALOR').AsFloat;
                        qrCaixa_mov.ParamByName('Valor').AsFloat := qrForma.FieldByName('VALOR_TOTAL').AsFloat;
                        qrCaixa_mov.ParamByName('VALOR_SAIDA').AsFloat := qrForma.FieldByName('VALOR_TROCO').AsFloat;
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add(':VALOR_ENTRADA,:VALOR,:VALOR_SAIDA,''100003'',7,''Venda '+qrFinalizadora.FieldByName('FZDES').AsString+' - CUPOM No. ' + qrpdv.fieldbyname('numero').asstring + ''',:cancelado,:numero,0,:hora,:forma,:PRESTACAO)');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
...
//                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('valor').asfloat;
//                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('VALOR_ENTRADA').asfloat;
//                      QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrpdv.fieldbyname('valor_total').asfloat;
                        try
                        qrcaixa_mov.ExecSQL;
                        except
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.clear;
                        qrcaixa_mov.sql.add('insert into c000044');
                        qrcaixa_mov.sql.add('(codigo,codcaixa,codoperador,data,entrada,valor,codconta,movimento,historico,cancelado,numero,nuvem_pendente,hora,forma,prestacao )');
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add('0,:VALOR,''100004'',4,''Venda '+qrFinalizadora.FieldByName('FZDES').AsString+' - CUPOM No. ' + qrpdv.fieldbyname('numero').asstring + ''',:cancelado,:numero,0,:hora,:forma,:prestacao)');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('valor').asfloat;
                        QRCAIXA_MOV.Params.ParamByName('cancelado').ASFLOAT := qrForma.FieldByName('CANCELADO').AsFloat;
                        qrCaixa_mov.ParamByName('NUMERO').AsString := qrForma.FieldByName('NUMERO').AsString;
//                      QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrpdv.fieldbyname('valor_total').asfloat;
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add(':VALOR_ENTRADA,:VALOR,''100005'',40,''Venda '+qrFinalizadora.FieldByName('FZDES').AsString+' - CUPOM No. ' + qrpdv.fieldbyname('numero').asstring + ''',:cancelado,:numero,0,:hora,:forma,:PRESTACAO)');

                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                        qrCaixa_mov.ParamByName('VALOR_ENTRADA').AsFloat := qrForma.FieldByName('VALOR_PAGO').AsFloat;
                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('valor').asfloat;
                        QRCAIXA_MOV.Params.ParamByName('cancelado').ASFLOAT := qrForma.FieldByName('CANCELADO').AsFloat;
                        qrCaixa_mov.ParamByName('NUMERO').AsString := qrForma.FieldByName('NUMERO').AsString;
                        qrCaixa_mov.ParamByName('HORA').AsTime := qrForma.FieldByName('HORA').AsDateTime;
...
//                qrPDV3.sql.add('and cancelado = 0');
                ...
                begin
                  ...
                  qrServidor.CLOSE;
                  qrServidor.SQL.CLEAR;
                  qrServidor.SQL.Add('update or insert into c000032');
                  ...
                  qrServidor.sql.add('base_calculo, valor_icms, codbarra,codcaixa,cancelado,nuvem)');
                  qrServidor.SQL.add('values');
                  ...
                  qrServidor.Params.ParamByName('CODCLIENTE').ASSTRING := zerar(qrpdv.FIELDBYNAME('COD_CLIENTE').ASSTRING, 6);
                  qrServidor.Params.ParamByName('CODVENDEDOR').ASSTRING := zerar(qrpdv.FIELDBYNAME('COD_VENDEDOR').ASSTRING, 6);
                  qrServidor.Params.ParamByName('CODBARRA').ASSTRING := qrpdv3.fieldbyname('COD_BARRA').asstring;
                  qrServidor.Params.ParamByName('CODCAIXA').AsString := zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6);
                  qrServidor.Params.ParamByName('CANCELADO').AsInteger := qrpdv.fieldbyname('cancelado').AsInteger;
                  qrServidor.Params.ParamByName('NUVEM').AsInteger := 0;
...
//                  qrServidor.Params.ParamByName('MOVIMENTO').ASINTEGER := 3;
                  end
                  else
                  begin
